...
export default {
  ...
  methods:{
    downloadExcel(){
      this.$axios.post(this.$httpUrl + '/repair/exportAll', {
        param: {
          name:this.name,
    ...
    del(){
      ...
      {
        this.delID.push(this.multipleSelection[i].repairId)
      }
    },
    ...
    delAll(){
      ...
      {
        this.$axios.get(this.$httpUrl + '/repair/delete?id='+this.delID[i], ).then(res=>{
          console.log(res);
    ...
    doMod(){
      ...
      this.$axios.post(this.$httpUrl + '/repair/update',
          {
            date:this.editForm.date,
            description:this.editForm.description,
            id:this.editForm.repairId,
    ...
    //加载列表
    loadPost(){
      this.$axios.post(this.$httpUrl + '/repair/listPage', {
