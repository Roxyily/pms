          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="最近一次维修时间">
                <el-date-picker type="date" placeholder="选择日期" v-model="form.lastInspectionDate" style="width: 100%;"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="下一次维修时间">
                <el-date-picker type="date" placeholder="选择日期" v-model="form.nextInspectionDate" style="width: 100%;"></el-date-picker>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
...
export default {
  ...
  methods:{
    downloadExcel(){
      this.$axios.post(this.$httpUrl + '/property-meter/exportAll', {
        param: {
    ...
    //添加记录
    doSave(){
      this.$axios.post(this.$httpUrl + '/property-meter/save',this.form).then(res=>{
        console.log(res);
