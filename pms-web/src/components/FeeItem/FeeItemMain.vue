<template>
  <div>
    <div>
      <div class="searchBox">
        <el-input v-model="feeItemName" placeholder="请输入收费项目" style="width: 200px"
...
export default {
  ...
  methods:{
    ...
    del(){
      ...
      {
        this.delID.push(this.multipleSelection[i].feeItemId)
      }
    },
    ...
    delAll(){
      ...
      {
        this.$axios.get(this.$httpUrl + '/fee-item/delete?id='+this.delID[i], ).then(res=>{
          console.log(res);
      ...
      this.$axios.post(this.$httpUrl + '/fee-item/update',
          {
            ...
            id:this.editForm.feeItemId,
            name:this.editForm.feeItemName,
    ...
    //加载列表
    loadPost(){
      this.$axios.post(this.$httpUrl + '/fee-item/listPage', {
